...
#define BC_NUM spadas::system::busChannelNum() // Bus / 总线
#define VC_NUM spadas::system::videoChannelNum() // Video / 视频
#define MTC_NUM spadas::system::manualTriggerChannelNum() // Manual trigger / 手动触发器
#define PCC_NUM spadas::system::pointCloudChannelNum() // Point cloud / 点云
