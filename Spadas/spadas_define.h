...
// Update log / 更新记录: Image::sub恢复为subImage。新增Image::forPixels。丰富Region2D/3D构造函数

// Version definition / 版本定义
#define SPADAS_VERSION_MAJOR 9
#define SPADAS_VERSION_MINOR 0
#define SPADAS_VERSION_BUILD 32
...
* \~English This document corresponds to Spadas version: 9.0.32 \n
* \~Chinese 本文档对应Spadas版本：9.0.32 \n
