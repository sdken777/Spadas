...
// Update log / 更新记录: 回注相关接口移除tolerance参数。改为Input/OutputTables::generalSamples/matrixSamples

// Version definition / 版本定义
#define SPADAS_VERSION_MAJOR 9
#define SPADAS_VERSION_MINOR 0
#define SPADAS_VERSION_BUILD 54
...
* \~English This document corresponds to Spadas version: 9.0.54 \n
* \~Chinese 本文档对应Spadas版本：9.0.54 \n
