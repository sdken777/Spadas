...
// Update log / 更新记录: 更新至IPluginV106。合并TransmitResult。Image(ImagePointer)检查有效性
...
* \~English This document corresponds to Spadas version: 8.10.2 \n
* \~Chinese 本文档对应Spadas版本：8.10.2 \n
