...
// Update log / 更新记录: SessionSampleVars中SPADAS_VARS部分改为public域。SessionGeneral/MatrixSampleVars移动至cpp

// Version definition / 版本定义
#define SPADAS_VERSION_MAJOR 9
#define SPADAS_VERSION_MINOR 0
#define SPADAS_VERSION_BUILD 53
...
* \~English This document corresponds to Spadas version: 9.0.53 \n
* \~Chinese 本文档对应Spadas版本：9.0.53 \n
