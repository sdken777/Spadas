...
// Update log / 更新记录: 新增SampleParser, SampleSync。SessionSampleBuffer::interpolate确保输出时间戳

// Version definition / 版本定义
#define SPADAS_VERSION_MAJOR 9
#define SPADAS_VERSION_MINOR 0
#define SPADAS_VERSION_BUILD 55
...
* \~English This document corresponds to Spadas version: 9.0.55 \n
* \~Chinese 本文档对应Spadas版本：9.0.55 \n
