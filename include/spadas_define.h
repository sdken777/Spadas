...
// Update log / 更新记录: 支持图像编解码jpeg, png。新增ImageFileFormat, Image(fileData)和Image::toBinary

// Version definition / 版本定义
#define SPADAS_VERSION_MAJOR 9
#define SPADAS_VERSION_MINOR 0
#define SPADAS_VERSION_BUILD 48
...
* \~English This document corresponds to Spadas version: 9.0.48 \n
* \~Chinese 本文档对应Spadas版本：9.0.48 \n
