...
// Update log / 更新记录: Array/Binary/StringSpan支持绑定至外部指针，并增加isRefCounting方法。Array/Binary/String::sub改为span，且index参数可选

// Version definition / 版本定义
#define SPADAS_VERSION_MAJOR 9
#define SPADAS_VERSION_MINOR 0
#define SPADAS_VERSION_BUILD 28
...
* \~English This document corresponds to Spadas version: 9.0.28 \n
* \~Chinese 本文档对应Spadas版本：9.0.28 \n
