...
// Update log / 更新记录: 修正createDecodeImageContext。Span构造函数中size为0直接返回不报错

// Version definition / 版本定义
#define SPADAS_VERSION_MAJOR 9
#define SPADAS_VERSION_MINOR 0
#define SPADAS_VERSION_BUILD 76
...
* \~English This document corresponds to Spadas version: 9.0.76 \n
* \~Chinese 本文档对应Spadas版本：9.0.76 \n
